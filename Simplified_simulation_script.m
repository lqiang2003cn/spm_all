...
% Lets go! Message passing and policy selection % Lets go! Message passing and policy selection % Lets go! Message passing and policy selection 
% Lets go! Message passing and policy selection % Lets go! Message passing and policy selection % Lets go! Message passing and policy selection 
% Lets go! Message passing and policy selection % Lets go! Message passing and policy selection % Lets go! Message passing and policy selection 
% Lets go! Message passing and policy selection % Lets go! Message passing and policy selection % Lets go! Message passing and policy selection 
% Lets go! Message passing and policy selection % Lets go! Message passing and policy selection % Lets go! Message passing and policy selection 
...
for t = 1:T % loop over time points  
    ...
    for ni = 1:Ni 
        ...
        n = (t - 1)*Ni + ni;
        gamma_update(n,1) = gamma(t); % simulated neural encoding of precision (posterior_beta^-1) at each iteration of variational updating
...
%%%%%%%%%%%%%%%%%%% end of top level script %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% end of top level script %%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%% end of top level script %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% end of top level script %%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%% end of top level script %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% end of top level script %%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%% end of top level script %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% end of top level script %%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%% end of top level script %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% end of top level script %%%%%%%%%%%%%%%%%%%
